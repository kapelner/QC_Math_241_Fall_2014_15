...
\easysubproblem In the limit of that manipulation in (d), what would the final r.v. be? The name and how it's distributed is all that's needed ($X \sim$ somthing).  \spc{1}
