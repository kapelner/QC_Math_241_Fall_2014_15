...
\easysubproblem We will now go a step further, consider the data above to be $\iid$ draws from one distribution --- the distribution you created in (c). Thus, the accidents for 2001 -- 2007 can be thought of as:

\beqn
X_{2001}, X_{2002}, \ldots, X_{2007} \iid f(x)  
\eeqn

where the $f(x)$ is the PMF of a model similar to the one you built in (c). Let:
